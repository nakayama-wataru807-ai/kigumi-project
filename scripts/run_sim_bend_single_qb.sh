...
JSON_ARG="${1:-kigumi-bending-single.json}"
if [[ "${JSON_ARG}" = /* ]]; then
    JSON_FILE="${JSON_ARG}"
else
...
OUT_DIR="/Users/quentinbecker/Library/CloudStorage/GoogleDrive-quentinbecker@g.ecc.u-tokyo.ac.jp/My Drive/kigumi-project/simulations/bending-single/${DATETIME}_simulation"
mkdir -p "${OUT_DIR}"
